...
const CreditNotes: React.FC = () => {
  ...
  const saveCreditNote = async () => {
    if (!creditNoteData.creditNoteNumber || !creditNoteData.invoiceNumber || !creditNoteData.supplier || !creditNoteData.reason) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCreditNoteData({ ...creditNoteData, creditNoteNumber: e.target.value })}
